            ...
            <div class="flex flex-col justify-between p-4 leading-normal w-full">
              <div class="flex justify-between">
                ...
                <div class="flex flex-col justify-between leading-normal md:w-8/12 lg:w-10/12 pe-4">
                  <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Full Name: Md.
                    Mazharul Islam Sohag</h5>
                  <div class="flex flex-col">
                    <span class="mb-2 leading-tight text-xs">Father's Name: <span
                        class="font-semibold text-slate-700 sm:ml-2">Md. Abdul Halim</span></span>
              ...
              <span class="mb-2 leading-tight text-xs">Skills: <span class="font-semibold text-slate-700 sm:ml-2">a, b,
                  c</span></span>
