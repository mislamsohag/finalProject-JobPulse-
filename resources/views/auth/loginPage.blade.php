                ...
                <div class="relative flex flex-col min-w-0 mt-32 break-words bg-transparent border-0 shadow-none rounded-2xl bg-clip-border">
                  ...
                  <div class="flex-auto p-6">
                    <form role="form" method="POST" action="{{url('userLogin')}}">
                      ...
                      <div class="mb-4">
                        <input name="password" type="text" class="focus:shadow-soft-primary-outline text-sm leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 transition-all focus:border-fuchsia-300 focus:outline-none focus:transition-shadow" placeholder="Password" aria-label="Password" aria-describedby="password-addon" />
                      </div>

                      <!-- Forget Password -->
                      <div class="min-h-6 mb-0.5 block">                        
                        <a href="{{url('forgetPage')}}" class="mb-2 font-normal cursor-pointer select-none text-sm text-slate-700" for="rememberMe">Forget Password?</a>
                      </div>
                  ...
                  <div class="p-6 px-1 pt-0 text-center bg-transparent border-t-0 border-t-solid rounded-b-2xl lg:px-2">
                    <p class="mx-auto mb-6 leading-normal text-sm">
                      ...
                      <a href="{{url('companySignupPage')}}" class="relative z-10 font-semibold text-transparent border p-1 bg-gradient-to-tl from-fuchsia-700 to-cyan-500 bg-clip-text">Company</a>
                      <a href="{{url('accountPage')}}" class="relative z-10 font-semibold text-transparent border p-1 bg-gradient-to-tl from-gray-700 to-cyan-500 bg-clip-text">Candidate</a>
                    </p>
                  </div>
                </div>
              </div>
