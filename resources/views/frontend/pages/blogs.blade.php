...
<div class="flex flex-wrap justify-between max-w-screen-xl pt-16">
    ...
    <article class="w-full max-w-2xl format format-sm sm:format-base lg:format-lg format-blue dark:format-invert">
        <header class="mb-4 lg:mb-4 not-format">
            <address class="flex items-center mb-4 not-italic">
            ...
            <h1 class="mb-4 text-3xl text-justify font-extrabold leading-tight text-gray-900 lg:mb-4 lg:text-4xl dark:text-white">Best practices for successful prototypes</h1>
        </header>
        <p class="lead text-justify">JobPulse is an open-source library of UI components built with the utility-first
            classes from Tailwind CSS. It also includes interactive elements such as dropdowns, modals,
            datepickers.</p>
        <p class="text-justify">Before going digital, you might benefit from scribbling down some ideas in a sketchbook. This way,
            you can think things through before committing to an actual design project.</p>
        <p class="text-justify">But then I found a <a href="https://flowbite.com">component library based on Tailwind CSS called
        ...
        <p class="text-justify">First of all you need to understand how JobPulse works. This library is not another framework.
            Rather, it is a set of components based on Tailwind CSS that you can just copy-paste from the
            documentation.</p>
        <p class="text-justify">It also includes a JavaScript file that enables interactive components, such as modals, dropdowns,
            and datepickers which you can optionally include into your project via CDN or NPM.</p>
        <p class="text-justify">You can check out the <a href="https://flowbite.com/docs/getting-started/quickstart/">quickstart
                guide</a> to explore the elements by including the CDN files into your project. But if you want
            to build a project with JobPulse I recommend you to follow the build tools steps so that you can
            purge and minify the generated CSS.</p>
        <p class="text-justify">You'll also receive a lot of useful application UI, marketing UI, and e-commerce pages that can help
        ...
        <blockquote>
            <p>JobPulse is just awesome. It contains tons of predesigned components and pages starting from
        ...
        <p class="text-justify"><strong>Low fidelity or high fidelity?</strong> Fidelity refers to how close a prototype will be to
        ...
        <p class="text-justify"><strong>Consider your user</strong>. To create an intuitive user flow, try to think as your user
            ...
            path.</p>
        <p class="text-justify"><strong>Start from the inside out</strong>. A nice way to both organize your tasks and create more
            ...
            of your design.</p>
        <p class="text-justify">And there you have it! Everything you need to design and share prototypes — right in JobPulse Figma.
        </p>
        <section class="not-format">
            ...
            <article class="p-6 mb-6 text-base bg-white rounded-lg dark:bg-gray-900">
                ...
                <p class="text-justify">Very straight-to-point article. Really worth time reading. Thank you! But tools are just the
